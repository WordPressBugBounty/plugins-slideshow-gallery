...
<div class="submitbox" id="submitpost">
	<div id="minor-publishing">
		<div id="misc-publishing-actions">
			<div class="misc-pub-section slideshow-setting-action">
			...
			<div class="misc-pub-section misc-pub-section-last slideshow-misc-pub-section-debug">
				<label class="slideshow-custom-checkbox slideshow-custom-checkbox-no-space slideshow-custom-checkbox-debug">
					<div class="slideshow-custom-checkbox-wrapper">
						<input <?php echo (!empty($debugging) && $debugging == 1) ? 'checked="checked"' : ''; ?> type="checkbox" name="debugging" value="1" id="debugging" />
						<span class="check-icon"></span>
					</div>
					<i class="fa fas fa-bug fa-fw"></i> <?php _e('Turn on debugging', 'slideshow-gallery'); ?>
				</label>
